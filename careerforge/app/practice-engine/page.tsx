...
import { RoadmapEngineView } from "@/components/practice-engine/RoadmapEngineView";
...
export default function PracticeEnginePage() {
  return (
    <main className="min-h-screen bg-[#0a0c12] text-slate-100 selection:bg-amber-400 selection:text-black">
      {/* Top Header Navigation - Bespoke Editorial & Developer Bar */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2.5">
              {/* Refined Geometric Node Brand Mark */}
              ...
              <div className="flex flex-col">
                <span className="font-semibold text-white text-sm sm:text-base leading-tight tracking-tight">
                  CareerForge <span className="text-slate-400 font-normal">/ Roadmap &amp; Drills</span>
                </span>
                <span className="text-[11px] text-slate-500 hidden sm:block">
                  Curated Developer Engineering Tracks
                </span>
              </div>
            </div>
          </div>

          {/* Right: Offline / CDN status & Fast Links */}
          <div className="flex items-center gap-3">
            <div className="hidden md:flex items-center gap-2 px-3 py-1 rounded-full text-xs font-mono bg-slate-900/90 border border-slate-800 text-slate-400 shadow-sm">
              ...
              <span>Synced Offline · Zero-Runtime-DB</span>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 py-8">
        <RoadmapEngineView initialTrack="frontend" />
      </div>
    </main>
  );
}
